...
class Settings_Route extends WP_REST_Controller  {
    ...
    public function get_items( $request ) {
        $response = [
            'firstname' => get_option( 'wphrm_settings_firstname', true ),
            'lastname'  => get_option( 'wphrm_settings_lastname', true ),
            'email'     => get_option( 'wphrm_settings_email', true ),
        ];
    ...
    public function create_items( $request ) {
        ...
        update_option( 'wphrm_settings_firstname', $firstname );
        update_option( 'wphrm_settings_lastname', $lastname );
        update_option( 'wphrm_settings_email', $email );
